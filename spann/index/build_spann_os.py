...
def build_index(corpus_name, corpus_path):
    ...
    index.SetBuildParam("IndexDirectory", corpus_name + "_1", "Base")
    ...
    index.SetBuildParam("SelectThreshold", "0", "SelectHead") 
    index.SetBuildParam("SplitFactor", "0", "SelectHead")    
    index.SetBuildParam("SplitThreshold", "0", "SelectHead")  
    index.SetBuildParam("Ratio", "0.5", "SelectHead")    
    index.SetBuildParam("NumberOfThreads", "96", "SelectHead")
    index.SetBuildParam("BKTLambdaFactor", "-1", "SelectHead")

    index.SetBuildParam("isExecute", "true", "BuildHead")
    index.SetBuildParam("Samples", "10000", "BuildHead")
    index.SetBuildParam("NeighborhoodSize", "32", "BuildHead")
    index.SetBuildParam("TPTNumber", "128", "BuildHead")
    ...
    index.SetBuildParam("NumberOfThreads", "96", "BuildHead")
    index.SetBuildParam("BKTLambdaFactor", "-1", "BuildHead")
    index.SetBuildParam("EnableBfs", "3", "BuildHead")
    index.SetBuildParam("CEF", "2000", "BuildHead")
    index.SetBuildParam("NumberOfInitialDynamicPivots", "100", "BuildHead")

    index.SetBuildParam("isExecute", "true", "BuildSSDIndex")
    index.SetBuildParam("BuildSsdIndex", "true", "BuildSSDIndex")
    index.SetBuildParam("InternalResultNum", "256", "BuildSSDIndex") # 256 change to 64
    index.SetBuildParam("ReplicaCount", "1", "BuildSSDIndex") 
    index.SetBuildParam("PostingPageLimit", "96", "BuildSSDIndex")
    index.SetBuildParam("NumberOfThreads", "96", "BuildSSDIndex")
    index.SetBuildParam("MaxCheck", "8192", "BuildSSDIndex")

    index.SetBuildParam("SearchPostingPageLimit", "96", "BuildSSDIndex")
    index.SetBuildParam("SearchInternalResultNum", "256", "BuildSSDIndex") # 256 change to 64
    ...
    index.SetBuildParam("SearchInternalResultNum", "256", "SearchSSDIndex") # 256 change to 64
    index.SetBuildParam("MaxDistRatio", "1000.0", "SearchSSDIndex")

    if index.Build(corpus, vector_number, False):
        index.Save(corpus_name + "_1")  # Save the index to the disk
