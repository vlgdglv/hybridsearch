...
def build_index(corpus_name, corpus_path):
    ...
    index.SetBuildParam("InternalResultNum", "256", "BuildSSDIndex")
    ...
    index.SetBuildParam("SearchInternalResultNum", "256", "BuildSSDIndex")
    ...
    index.SetBuildParam("SearchInternalResultNum", "256", "SearchSSDIndex")
